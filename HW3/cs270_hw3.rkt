...
(define (binplus a b)
  (cond
    [(binzero? a) b]
    [(binzero? b) a]
    [(and (double? a) (double? b)) (double (binplus (first (rest a)) (op b)))]
...
(define (binmult a b)
  (cond
    ...
    [(and (double? a) (double? b)) (double (binmult a (op b)))]
    [(double-plus1? b) (binplus a (double (binmult a (op b))))]
    [(double-plus1? a) (binplus b (double (binmult (op a) b)))])
)
